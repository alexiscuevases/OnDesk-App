			...
			<div className="hidden lg:block lg:flex-1 relative bg-muted">
				...
				<div className="relative flex h-full items-center justify-center p-12">
					<div className="max-w-md space-y-6 text-center">
						<h2 className="text-3xl font-bold text-balance">Automate customer engagement with AI</h2>
						<p className="text-lg text-muted-foreground text-pretty leading-relaxed">
							Join thousands of businesses using AgentHub to provide 24/7 customer support through AI-powered agents.
						</p>
					</div>
				</div>
			</div>
