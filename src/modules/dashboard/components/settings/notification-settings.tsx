        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Get notified when agents receive new messages</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Receive alerts about agent performance issues</p>
            </div>
            <Switch defaultChecked />
          </div>
