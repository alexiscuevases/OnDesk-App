...
import { Connection, CreateConnectionInput, createConnectionSchema } from '@/modules/connections/lib/validations';
...
export function ConnectIntegrationDialog({ children, integration }: ConnectIntegrationDialogProps) {
	...
	const {
		...
		resolver: zodResolver(createConnectionSchema) as any,
		defaultValues: {
