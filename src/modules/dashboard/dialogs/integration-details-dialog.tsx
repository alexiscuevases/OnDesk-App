...
import { formatDate_DistanceToNow } from '@/shared/lib/utils';
import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { useIntegrations } from '@/modules/integrations/hooks/use-integrations';
import { CreateIntegrationInput, Integration, UpdateIntegrationInput, updateIntegrationSchema } from '@/modules/integrations/lib/validations';
...
export function IntegrationDetailsDialog({ open, onOpenChange, integration }: IntegrationDetailsDialogProps) {
	...
	const {
		...
		resolver: zodResolver(updateIntegrationSchema) as any,
		defaultValues: {
			config: {},
		},
	});
