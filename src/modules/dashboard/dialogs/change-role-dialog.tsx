...
import { TeamMember } from '@/modules/teams/lib/validations-member';
		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-[450px]">
				<form onSubmit={handleSubmit}>
					...
					<div className="py-6">
						<RadioGroup value={selectedRole} onValueChange={(val) => setSelectedRole(val as any)} className="space-y-4">
