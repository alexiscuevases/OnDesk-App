...
import { signUpSchema, type SignUpInput } from '@/modules/auth/lib/validations';
	...
	return (
		<form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
			...
			<div className="space-y-2">
				...
				<Input id="password" type="password" placeholder="Create a strong password" disabled={isLoading} {...register("password")} />
